...
const BlogDetails = () => {
  return (
    <>
      {/* Changed "Blog Details" to "Product Details" */}
      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[750px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="rounded-[10px] overflow-hidden mb-7.5">
            {/* This image will now represent a product */}
            <Image
              className="rounded-[10px]"
              src="/images/blog/blog-details-01.jpg" // Keep the image path as requested
              alt="Premium Smartphone" // Updated alt text for relevance
              width={750}
              height={477}
            />
          </div>
          ...
          <div>
            <span className="flex items-center gap-3 mb-4">
              {/* Changed date to a product launch/availability date if applicable, or remove */}
              ...
              {/* Changed views to a "Rating" or "Reviews" count */}
              <a href="#" className="ease-out duration-200 hover:text-blue">
                4.8 Stars (250+ Reviews)
              </a>
            </span>

            {/* Changed title to a product name */}
            <h2 className="font-medium text-dark text-xl lg:text-2xl xl:text-custom-4xl mb-4">
              TechNexus Pro X Smartphone: The Future in Your Hand
            </h2>

            {/* Product description paragraph 1 */}
            <p className="mb-6">
              Introducing the TechNexus Pro X, a revolutionary smartphone designed to elevate your digital experience. With its stunning edge-to-edge display, powerful A15 Bionic chip, and an advanced camera system, the Pro X captures life&#39;s moments in breathtaking detail and handles demanding tasks with effortless grace. Experience unparalleled speed and efficiency for all your applications.
            </p>

            {/* Product description paragraph 2 */}
            <p className="mb-6">
              Crafted from premium aerospace-grade aluminum and Ceramic Shield, the TechNexus Pro X is not only beautiful but also incredibly durable. Its innovative design provides a comfortable grip, while IP68 water resistance ensures peace of mind against splashes and spills. Dive into vibrant colors and incredible contrast with the Super Retina XDR display.
            </p>

            {/* Product features */}
            <p>
              Stay connected and productive with ultra-fast 5G capabilities, ensuring seamless streaming, downloading, and video calls. The long-lasting battery life means you can power through your day without constantly searching for a charger. Security is paramount with advanced facial recognition technology, keeping your data safe and accessible only to you.
            </p>
            ...
            <div className="mt-7.5">
              ...
              <ul className="list-disc pl-6">
                <li>Stunning 6.7-inch Super Retina XDR Display with ProMotion.</li>
                <li>Next-gen A15 Bionic Chip for ultimate performance.</li>
                <li>Advanced Triple-Lens Camera System with Night Mode and Cinematic Mode.</li>
                <li>Blazing-fast 5G connectivity for seamless Browse and streaming.</li>
                <li>Long-lasting battery with fast charging capabilities.</li>
                <li>Durable Ceramic Shield front cover and IP68 water resistance.</li>
              </ul>
            </div>

            <div className="rounded-xl bg-white pt-7.5 pb-6 px-4 sm:px-7.5 my-7.5">
              <p className="italic text-dark text-center">
                &#34;The TechNexus Pro X redefines what a smartphone can be. Its blend of power, design, and innovation sets a new standard for mobile technology.&#34;
              </p>

              {/* Testimonial/Expert Reviewer section - could be a customer review or tech reviewer */}
              <a
                href="#"
              ...
              >
                <div className="flex w-12 h-12 rounded-full overflow-hidden">
                  <Image
                    src="/images/users/user-04.jpg" // Keep the user image path
                    alt="Reviewer"
                    width={48}
                    height={48}
                  />
                ...
                <div>
                  <h4 className="text-dark text-custom-sm">TechGadget Insider</h4>
                  <p className="text-custom-xs">Leading Tech Reviewer</p>
                </div>
              </a>
            </div>
            ...
            <p className="mb-6">
              The TechNexus Pro X isn&#39;t just a phone; it&#39;s a statement. Experience crystal-clear audio with enhanced stereo speakers, perfect for music and calls. The intuitive iOS interface offers a smooth and secure user experience, with access to millions of apps to personalize your device.
            </p>

            <p className="mb-6">
              Available in a range of sophisticated colors, including Midnight Black, Starlight White, Sierra Blue, and Graphite. Choose the storage option that suits your needs, from 128GB to 1TB. Each purchase includes a complimentary 1-year warranty and access to TechNexus&#39;s premium customer support.
            </p>

            <p className="mb-6">
              Pre-order yours today and be among the first to experience the future of mobile technology. Limited stock available.
            </p>

            <p>
              Visit our accessories section for compatible cases, screen protectors, and chargers to complete your TechNexus Pro X experience.
            </p>

            <div className="flex flex-wrap items-center justify-between gap-10 mt-10">
              <div className="flex flex-wrap items-center gap-5">
                <p>Related Products / Categories :</p>

                {/* Updated tags for e-commerce products */}
              ...
              {/* Social Links - kept as is, but now for sharing products */}
